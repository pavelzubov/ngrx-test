...
import {
    ...
    getSocketSymbolTicket, getSocketSymbolMiniTicker
} from '../store/reducers';
import {map} from 'rxjs/operators';
import {GetMiniTrackerArrSocketRequest, GetSymbolMiniTickerSocketRequest} from '../store/actions/socket.actions';
